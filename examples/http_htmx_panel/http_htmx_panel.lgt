...
').
	...
	request_mode_label(Request, 'boosted HTMX request') :-
		http::property(Request, htmx_boosted(true)),
		!.
	request_mode_label(Request, 'non-boosted HTMX request') :-
		http::property(Request, htmx_request(true)),
		!.
	request_mode_label(_Request, 'ordinary request').
