...
:- initialization((
	...
	(logtalk_load(conflicting_scope_directives) -> true; true),
	(logtalk_load(conflicting_meta_predicate_directives) -> true; true),
	(logtalk_load(conflicting_meta_non_terminal_directives) -> true; true),
	...
	(logtalk_load(redefined_object_alias) -> true; true),
