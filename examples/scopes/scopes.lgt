...
:- object(prototype).
	...
	% descendant objects can define this predicate and call inherited
	...
	% descendant objects can define this predicate but cannot acess any
...
:- object(descendant,
	...
	:- public(d_foo/1).
	% access any inherited definition
	d_foo(X) :-
		^^foo(X).
