...
function usage_help() {
	WScript.Echo("");
	WScript.Echo("This script automates running unit tests found on the sub-directories");
	WScript.Echo("of the directory containing this script.");
	WScript.Echo("");
	WScript.Echo("Usage:");
	WScript.Echo("  " + WScript.ScriptName + " [/p:prolog] [/d:results]");
	WScript.Echo("  " + WScript.ScriptName + " help");
	WScript.Echo("");
	WScript.Echo("Optional arguments:");
	WScript.Echo("  p - format of the index file (either xhtml or html; default is " + format + ")");
	WScript.Echo("  d - name of the index file (default is " + index_file + ")");
