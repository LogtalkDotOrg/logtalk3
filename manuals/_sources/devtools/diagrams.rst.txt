...
As local links use absolute paths, the ``omit_path_prefixes/1`` option
is ignored. Note that local links require text editor support for URL
schemes that can handle both file and directory links.
