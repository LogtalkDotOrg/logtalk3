...
name ``tar``; you can create a ``bsdtar`` alias or preferably install a
more recent version). GNU coreutils can be installed easily using
MacPorts (``sudo port install coretutils``) or Homebrew
