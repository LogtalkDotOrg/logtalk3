...
`binomial/3`, `logistic/1-3`, `poisson/2`, `power/2`, `weibull/2-3`,
`uniform/3`, `circular_uniform_polar/3`, `circular_uniform_cartesian/3`,
and `triangular/4` to the `random` library for drawing samples from the
