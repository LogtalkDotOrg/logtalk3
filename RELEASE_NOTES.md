...
XSLT file to convert the reports to HTML now accepts an `url` parameter
that generates entity and predicate links to selected source code hosting
providers (currently Bitbucket, GitHub, or GitLab).
