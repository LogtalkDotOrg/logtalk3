...
* IMPROVED: Tests for the `barriers` `blackboard`, `buckets`, `checkpoint`,
`metered_concurrency`, `ping_pong`, `sorting`, and `team` multi-threading
examples by using explicit assertions.
