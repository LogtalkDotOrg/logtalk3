...
`chi_squared/2`, `standard_t/2`, `exponential/2`, `geometric/2`, `binomial/3`,
`logistic/1-3`, `poisson/2`, `power/2`, `weibull/2-3`, `uniform/3`,
`circular_uniform_polar/3`, `circular_uniform_cartesian/3`, and `triangular/4`
to the `random` library for drawing samples from the corresponding probability
distributions.
...
* UPDATED: Require Trealla Prolog 1.8.72 or later version.
