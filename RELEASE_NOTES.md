...
* FIXED: Bug where auxiliary predicates generated by the compiler or by calls
to the `logtalk::compile_aux_clauses/1` method would have `line_count/1` and
`number_of_clauses/1` properties.
