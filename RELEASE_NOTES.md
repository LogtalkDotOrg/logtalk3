...
* UPDATED: Adapter files for Quintus Prolog, SICStus Prolog, and YAP to ensure
that user changes to the `syntax_errors` Prolog flag do not affect the compiler
