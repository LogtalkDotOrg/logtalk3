...
* CHANGED: The `diagrams` tool now always prints library names and file names
when generating entity and cross-referencing predicate call diagrams. Removed
the option `library_paths/1` and `file_names/1`.

* IMPROVED: The appearance of the diagrams generated by the `diagrams` tool.
