...
Open the
`../../apis/library_index.html#glicko2 <../../apis/library_index.html#glicko2>`__
...
::
   ...
   | ?- glicko2::learn(my_dataset, Ranker).
   ...

   % Learn with custom Glicko-2 parameters
   | ?- glicko2::learn(my_dataset, Ranker, [initial_rating(1400.0), initial_deviation(300.0), initial_volatility(0.07), tau(0.4)]).
   ...
...
::
   ...
   | ?- glicko2::learn(my_dataset, Ranker),
        glicko2::rank(Ranker, [item_a, item_b, item_c], Ranking).
   Ranking = [...]
   ...
...
::
   ...
   | ?- glicko2::learn(my_dataset, Ranker),
        glicko2::export_to_clauses(my_dataset, Ranker, my_ranker, Clauses).
   Clauses = [my_ranker(glicko2_ranker(...))]
   ...

   % Export to a file
   | ?- glicko2::learn(my_dataset, Ranker),
        glicko2::export_to_file(my_dataset, Ranker, my_ranker, 'ranker.pl').
   ...
