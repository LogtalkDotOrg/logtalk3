...
- ``hybrid_language_detector`` combines the n-gram and stop-word scores
  using weights of 0.75 and 0.25, respectively. When only one strategy
  finds evidence, its scores are returned unchanged.
