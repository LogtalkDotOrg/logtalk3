...
from a dataset, computes anomaly scores for new instances, predicts
...
Open the
`../../apis/library_index.html#knn_distance <../../apis/library_index.html#knn_distance>`__
