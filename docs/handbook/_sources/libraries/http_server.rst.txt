...
- The ``accept_websocket/3`` helper is limited to the HTTP opening
  handshake. This layer does not hand upgraded connections off to a
  frame-processing loop, and ``serve_connection/3`` remains HTTP-request
  oriented.
