...
`../../../docs/apis/library_index.html#wrapper <../../../docs/apis/library_index.html#wrapper>`__
...
- The tool cannot deal with syntax errors in the Prolog files. These
  ...
  of syntax errors is operator definitions. These can often be solved by
  defining those operators for the Prolog backend used to run Logtalk
