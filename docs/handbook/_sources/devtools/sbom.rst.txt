...
- ``name(Name)`` Sets the application name. Exported as the SPDX
  ...
  ``metadata.component.name``. Default is ``loaded-application``.
...
- ``version(Version)`` Sets the application version. Exported as the
  ...
  ``metadata.component.version``. Default is ``0.0.0``.
...
- ``application_built_date(Date)`` Sets the application build date.
  ...
  the CycloneDX custom property ``logtalk:sbom:built_date``. Default is
  not exporting this information.
- ``application_release_date(Date)`` Sets the application release date.
  ...
  the CycloneDX custom property ``logtalk:sbom:release_date``. Default
  is not exporting this information.
