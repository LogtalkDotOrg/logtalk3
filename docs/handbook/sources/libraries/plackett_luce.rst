...
Open the
`../../apis/library_index.html#plackett_luce <../../apis/library_index.html#plackett_luce>`__
...
- ``model(plackett_luce)`` identifies the learning algorithm that
  produced the ranker.
