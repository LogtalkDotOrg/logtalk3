...
Open the
`../../apis/library_index.html#kernel_pca <../../apis/library_index.html#kernel_pca>`__
...
::
   ...
   | ?- logtalk_load(kernel_pca(loader)).
...
::
   ...
   | ?- logtalk_load(kernel_pca(tester)).
...
::
   ...
   | ?- kernel_pca::learn(correlated_plane, DimensionReducer, [n_components(1)]),
        kernel_pca::export_to_file(correlated_plane, DimensionReducer, reducer, 'kernel_pca_reducer.pl').
