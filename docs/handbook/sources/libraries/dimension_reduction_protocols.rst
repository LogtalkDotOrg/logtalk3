...
reducers are represented as objects importing the
...
libraries such as ``pca``, ``random_projection``, and
``lda_projection``, including shared reducer helpers for common tasks
such as feature encoding, projection, export, and pretty-printing.
