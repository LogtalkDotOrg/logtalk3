...
- ``attribute_values/2`` - enumerates attributes and their possible
  values; for discrete attributes, the values is a list of possible
  values; for continuous attributes, the value is the atom
  ``continuous``
...
- Handling of missing attribute values (represented using anonymous
  ...
  being evaluated
- Export of learned decision trees as lists of predicate clauses or to
  files
