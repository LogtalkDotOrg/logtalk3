...
Open the
`../../docs/library_index.html#knn <../../docs/library_index.html#knn>`__
...
The following options can be passed to the ``learn/3``, ``predict/4``,
and ``predict_probabilities/4`` predicates:
...
2. Hastie, T., Tibshirani, R., & Friedman, J. (2009). "The Elements of
   Statistical Learning". Chapter 13.
3. Mitchell, T. (1997). "Machine Learning". Chapter 8: Instance-Based
   Learning.
