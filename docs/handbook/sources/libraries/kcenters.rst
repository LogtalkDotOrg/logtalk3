...
Open the
`../../apis/library_index.html#kcenters <../../apis/library_index.html#kcenters>`__
...
- **Rich Training Diagnostics**: Learned clusterers report training
  example count, selected center count, and the center-selection
...
- ``initialization(Initialization)``: Center initialization strategy.
...
1. Gonzalez (1985) - "Clustering to minimize the maximum intercluster
