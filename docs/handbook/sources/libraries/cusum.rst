...
``cusum/tests.lgt`` file for example datasets.

API documentation
-----------------

Open the
`../../apis/library_index.html#cusum <../../apis/library_index.html#cusum>`__
