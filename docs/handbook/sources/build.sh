...
sed '1,19d' ../../../library/kernel_pca/NOTES.md | pandoc -f gfm -t rst -o libraries/kernel_pca.rst
...
sed '1,19d' ../../../library/massey/NOTES.md | pandoc -f gfm -t rst -o libraries/massey.rst
...
sed '1,19d' ../../../library/truncated_svd/NOTES.md | pandoc -f gfm -t rst -o libraries/truncated_svd.rst
