...
``date_time_string/3``, ``duration_string/2``, and
``interval_string/2``.
...
- ``date_time(Year,Month,Day,Hours,Minutes,Seconds)`` for local
  date-time strings
- ``date_time(Year,Month,Day,Hours,Minutes,Seconds,OffsetSeconds)`` for
...
``2026-W15-2T14:30:00Z/PT30M``, or ``2026-02-25/P3D``). Support negative
durations.
