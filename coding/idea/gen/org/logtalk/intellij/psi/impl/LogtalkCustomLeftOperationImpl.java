...
public class LogtalkCustomLeftOperationImpl extends ASTWrapperPsiElement implements LogtalkCustomLeftOperation {

  public LogtalkCustomLeftOperationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LogtalkVisitor visitor) {
    visitor.visitCustomLeftOperation(this);
  }
  ...
  public LogtalkAtom getAtom() {
    return findNotNullChildByClass(LogtalkAtom.class);
  }
