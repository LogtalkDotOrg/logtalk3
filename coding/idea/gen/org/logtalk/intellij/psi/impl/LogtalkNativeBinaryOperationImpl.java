...
public class LogtalkNativeBinaryOperationImpl extends ASTWrapperPsiElement implements LogtalkNativeBinaryOperation {

  public LogtalkNativeBinaryOperationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LogtalkVisitor visitor) {
    visitor.visitNativeBinaryOperation(this);
  }
  ...
  public LogtalkKnownBinaryOperator getKnownBinaryOperator() {
    return findNotNullChildByClass(LogtalkKnownBinaryOperator.class);
  }
