...
public class LogtalkCustomBinaryOperationImpl extends ASTWrapperPsiElement implements LogtalkCustomBinaryOperation {

  public LogtalkCustomBinaryOperationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LogtalkVisitor visitor) {
    visitor.visitCustomBinaryOperation(this);
  }
