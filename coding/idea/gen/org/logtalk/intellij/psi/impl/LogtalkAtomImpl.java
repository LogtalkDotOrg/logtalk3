...
public class LogtalkAtomImpl extends ASTWrapperPsiElement implements LogtalkAtom {

  public LogtalkAtomImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public LogtalkKnownOperator getKnownOperator() {
    return findChildByClass(LogtalkKnownOperator.class);
  }
