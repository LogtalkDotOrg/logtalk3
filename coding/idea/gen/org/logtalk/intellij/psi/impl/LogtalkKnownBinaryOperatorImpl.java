...
public class LogtalkKnownBinaryOperatorImpl extends ASTWrapperPsiElement implements LogtalkKnownBinaryOperator {

  public LogtalkKnownBinaryOperatorImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LogtalkVisitor visitor) {
    visitor.visitKnownBinaryOperator(this);
  }
