...
OPERATOR_SYMBOLS = {NON_COMBINABLE_OPERATOR_SYMBOLS} | {COMBINABLE_OPERATOR_SYMBOLS}+ | ({COMBINABLE_OPERATOR_SYMBOLS} | "."){2}

%state SENTENCE, SINGLE_QUOTE_STRING, DOUBLE_QUOTE_STRING, CHAR_CODE
