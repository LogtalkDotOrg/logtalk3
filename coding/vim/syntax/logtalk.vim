...
syn match	logtalkBuiltIn		"\<logtalk_\(compile\|l\(ibrary_path\|oad\|oad_context\)\|make\)\ze("
...
syn match	logtalkBuiltIn		"\<threaded_engine\(_\(create\|destroy\|self\|next\|yield\|post\|fetch\)\)\?\ze("
