-- Copyright © 2018-2019 Michael T. Richter <ttmrichter@gmail.com>. See LICENSE.
-- Logtalk LPeg lexer.
...
local keyword = token(l.KEYWORD, word_match{
  ...
  'conforms_to_protocol', 'context', 'create', 'create_category', 'create_object',
  ...
  'define_events', 'domain_error', 'encoding', 'end_category', 'end_class', 'end_object',
  'end_protocol', 'evaluation_error', 'existence_error', 'extends', 'extends_category',
  'extends_object', 'extends_protocol', 'forward', 'implements', 'implements_protocol',
  'imports', 'imports_category', 'include', 'info', 'instantiates', 'instantiates_class',
  'instantiation_error', 'is', 'logtalk_compile', 'logtalk_library_path', 'logtalk_load',
  'logtalk_load_context', 'logtalk_make', 'logtalk_make_target_action',
  'meta_non_terminal', 'mode', 'object', 'object_property', 'parameter', 'permission_error',
  'private', 'protected', 'protocol_property', 'representation_error', 'resource_error',
  'self', 'sender', 'set_logtalk_flag', 'specializes', 'specializes_class',
  'synchronized', 'syntax_error', 'system_error', 'this', 'threaded', 'threaded_call',
  'threaded_engine', 'threaded_engine_create', 'threaded_engine_destroy',
  'threaded_engine_fetch', 'threaded_engine_next', 'threaded_engine_next_reified',
  ...
  'threaded_peek', 'threaded_cancel', 'threaded_wait', 'type_error', 'uses',
