;(function()
{
	...
	function Brush()
	{
		// Contributed by Paulo Moura (http://logtalk.org/); last revised on May 29, 2016
		...
		this.regexList = [
		  // variables
			...
			{ regex: new RegExp("\\bthreaded_engine(_(create|stop|self|answer|return|post|fetch))?(?=[(])", 'g'), css: 'keyword'},
