...
:parameters ()
:precondition (and (not-made p1)(started o11))
:effect (and (not (not-made p1)) (made p1))
)

(:action make-product-p2
:parameters ()
:precondition (and (not-made p2)(started o1)(started o5)(started o8)(started o11))
:effect (and (not (not-made p2)) (made p2))
)

(:action make-product-p3
:parameters ()
:precondition (and (not-made p3)(started o4))
...
:parameters ()
:precondition (and (not-made p5)(started o7))
...
:parameters ()
:precondition (and (not-made p7)(started o2)(started o13))
...
:parameters ()
:precondition (and (not-made p9)(started o6)(started o14))
:effect (and (not (not-made p9)) (made p9))
)

(:action make-product-p10
:parameters ()
:precondition (and (not-made p10)(started o8)(started o9)(started o10))
...
:parameters ()
:precondition (and (not-made p12)(started o10))
...
:parameters ()
:precondition (and (not-made p14)(started o4))
...
:parameters (?avail ?new-avail - count)
:precondition (and (started o4)(made p3)(made p4)(made p11)(made p14)(stacks-avail ?avail)(next-count ?avail ?new-avail))
...
:parameters (?avail ?new-avail - count)
:precondition (and (started o8)(made p2)(made p10)(stacks-avail ?avail)(next-count ?avail ?new-avail))
...
:parameters (?avail ?new-avail - count)
:precondition (and (started o10)(made p10)(made p12)(stacks-avail ?avail)(next-count ?avail ?new-avail))
:effect (and (not (started o10))(shipped o10)(not (stacks-avail ?avail))(stacks-avail ?new-avail)))

(:action ship-order-o11
:parameters (?avail ?new-avail - count)
:precondition (and (started o11)(made p1)(made p2)(stacks-avail ?avail)(next-count ?avail ?new-avail))
...
:parameters (?avail ?new-avail - count)
:precondition (and (started o14)(made p9)(made p15)(stacks-avail ?avail)(next-count ?avail ?new-avail))
