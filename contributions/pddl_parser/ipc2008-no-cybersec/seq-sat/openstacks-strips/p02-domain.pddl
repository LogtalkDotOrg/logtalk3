...
:parameters ()
:precondition (and (not-made p1)(started o1)(started o2)(started o5))
...
:precondition (and (started o1)(made p1)(made p3)(stacks-avail ?avail)(next-count ?avail ?new-avail))
...
:parameters (?avail ?new-avail - count)
:precondition (and (started o3)(made p2)(made p4)(stacks-avail ?avail)(next-count ?avail ?new-avail))
