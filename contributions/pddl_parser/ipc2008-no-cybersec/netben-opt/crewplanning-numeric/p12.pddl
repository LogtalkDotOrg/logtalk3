...
(:init
	...
	(= (payloadact_length pa5) 140)
	(= (payloadact_length pa6) 80)
	(= (payloadact_length pa7) 120)
	(= (payloadact_length pa8) 160)
...
(:metric maximize
	...
	(* (is-violated dr) 2745)
	    ...
	    (* (is-violated pref_pa1) 100)
	    (* (is-violated pref_pa2) 90)
	    (* (is-violated pref_pa3) 150)
	    (* (is-violated pref_pa4) 90)
	    (* (is-violated pref_pa5) 140)
	    (* (is-violated pref_pa6) 80)
	    (* (is-violated pref_pa7) 120)
	    (* (is-violated pref_pa8) 160)
	    (* (is-violated pref_pa9) 140)
	    (* (is-violated pref_pa10) 100)
)))
)
