; Transport city-netbenefit-0petrol-station-13nodes-1000size-3degree-100mindistance-2trucks-5packagespercity-2008seed

(define (problem transport-city-netbenefit-0petrol-station-13nodes-1000size-3degree-100mindistance-2trucks-5packagespercity-2008seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
 ...
 (:init
  ...
  (= (fuel-left truck-1) 486)
  (= (fuel-max truck-1) 486)
  (at truck-2 city-loc-1)
  (capacity truck-2 capacity-4)
  (= (fuel-left truck-2) 486)
  (= (fuel-max truck-2) 486)
 )
 (:goal (and
  (preference delivery-1 (at package-1 city-loc-5))
  (preference delivery-2 (at package-2 city-loc-11))
  (preference delivery-3 (at package-3 city-loc-1))
  (preference delivery-4 (at package-4 city-loc-2))
  (preference delivery-5 (at package-5 city-loc-6))
 ))
 (:metric maximize
   (- 579
     (+ (total-cost)
       (* (is-violated delivery-1) 94)
       (* (is-violated delivery-2) 135)
       (* (is-violated delivery-3) 137)
       (* (is-violated delivery-4) 74)
       (* (is-violated delivery-5) 139)
     )
   )
 )
)
