; Transport city-netbenefit-0petrol-station-11nodes-1000size-3degree-100mindistance-2trucks-4packagespercity-2008seed

(define (problem transport-city-netbenefit-0petrol-station-11nodes-1000size-3degree-100mindistance-2trucks-4packagespercity-2008seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
 ...
 (:goal (and
  (preference delivery-1 (at package-1 city-loc-3))
  (preference delivery-2 (at package-2 city-loc-7))
  (preference delivery-3 (at package-3 city-loc-2))
  (preference delivery-4 (at package-4 city-loc-9))
 ))
 (:metric maximize
   (- 355
     (+ (total-cost)
       (* (is-violated delivery-1) 93)
       (* (is-violated delivery-2) 121)
       (* (is-violated delivery-3) 54)
       (* (is-violated delivery-4) 87)
     )
   )
 )
)
