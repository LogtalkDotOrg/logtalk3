; Transport city-netbenefit-0petrol-station-9nodes-1000size-3degree-100mindistance-2trucks-3packagespercity-2008seed

(define (problem transport-city-netbenefit-0petrol-station-9nodes-1000size-3degree-100mindistance-2trucks-3packagespercity-2008seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
 ...
 (:init
  ...
  (= (fuel-demand city-loc-9 city-loc-2) 79)
  ; 384,50 -> 273,425
  (road city-loc-2 city-loc-9)
  (= (road-length city-loc-2 city-loc-9) 40)
  (= (fuel-demand city-loc-2 city-loc-9) 79)
  ; 273,425 -> 456,221
  ...
  (= (fuel-left truck-1) 361)
  (= (fuel-max truck-1) 361)
  (at truck-2 city-loc-9)
  (capacity truck-2 capacity-3)
  (= (fuel-left truck-2) 361)
  (= (fuel-max truck-2) 361)
 )
 (:goal (and
  (preference delivery-1 (at package-1 city-loc-9))
  (preference delivery-2 (at package-2 city-loc-9))
  (preference delivery-3 (at package-3 city-loc-3))
 ))
 (:metric maximize
   (- 298
     (+ (total-cost)
       (* (is-violated delivery-1) 56)
       (* (is-violated delivery-2) 111)
