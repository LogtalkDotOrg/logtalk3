(define (problem elevators-netbenefit-p12_7_4)
...
(= (passengers fast1) 0)
(= (capacity fast1) 3)
(reachable-floor fast1 f0)(reachable-floor fast1 f3)(reachable-floor fast1 f6)(reachable-floor fast1 f9)(reachable-floor fast1 f12)
...
(:goal
(and
(preference served0 (passenger-at p0 f11)) 
(preference served1 (passenger-at p1 f1)) 
(preference served2 (passenger-at p2 f9)) 
(preference served3 (passenger-at p3 f0)) 
(preference served4 (passenger-at p4 f1)) 
(preference served5 (passenger-at p5 f6)) 
(preference served6 (passenger-at p6 f10)) 
))

(:metric maximize (- 726 (+ (total-cost)
(* (is-violated served0) 16)
(* (is-violated served1) 162)
(* (is-violated served2) 144)
(* (is-violated served3) 162)
(* (is-violated served4) 162)
(* (is-violated served5) 16)
(* (is-violated served6) 64)
)))
