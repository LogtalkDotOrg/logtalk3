(define (problem elevators-netbenefit-p12_5_1)
...
(:goal
(and
(preference served0 (passenger-at p0 f5)) 
(preference served1 (passenger-at p1 f6)) 
(preference served2 (passenger-at p2 f10)) 
(preference served3 (passenger-at p3 f8)) 
(preference served4 (passenger-at p4 f9)) 
))

(:metric maximize (- 442 (+ (total-cost)
(* (is-violated served0) 64)
(* (is-violated served1) 32)
(* (is-violated served2) 324)
(* (is-violated served3) 18)
(* (is-violated served4) 4)
)))
