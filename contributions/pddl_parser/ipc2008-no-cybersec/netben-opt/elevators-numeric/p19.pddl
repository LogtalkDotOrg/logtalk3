(define (problem elevators-netbenefit-p12_7_3)
...
(:goal
(and
(preference served0 (passenger-at p0 f9)) 
(preference served1 (passenger-at p1 f4)) 
(preference served2 (passenger-at p2 f10)) 
(preference served3 (passenger-at p3 f8)) 
(preference served4 (passenger-at p4 f10)) 
(preference served5 (passenger-at p5 f12)) 
(preference served6 (passenger-at p6 f4)) 
))

(:metric maximize (- 1404 (+ (total-cost)
(* (is-violated served0) 256)
(* (is-violated served1) 16)
(* (is-violated served2) 400)
(* (is-violated served3) 256)
(* (is-violated served4) 324)
(* (is-violated served5) 144)
(* (is-violated served6) 8)
)))
