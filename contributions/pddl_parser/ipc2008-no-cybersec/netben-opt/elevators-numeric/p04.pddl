(define (problem elevators-netbenefit-p8_4_2)
...
(:goal
(and
(preference served0 (passenger-at p0 f1)) 
(preference served1 (passenger-at p1 f3)) 
(preference served2 (passenger-at p2 f4)) 
(preference served3 (passenger-at p3 f2)) 
))

(:metric maximize (- 102 (+ (total-cost)
(* (is-violated served0) 50)
(* (is-violated served1) 18)
(* (is-violated served2) 2)
(* (is-violated served3) 32)
)))
