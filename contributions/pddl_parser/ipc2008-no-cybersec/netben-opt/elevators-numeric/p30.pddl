(define (problem elevators-netbenefit-p12_7_2)
...
(preference served1 (passenger-at p1 f0)) 
(preference served2 (passenger-at p2 f4)) 
...
(:metric maximize (- 714 (+ (total-cost)
(* (is-violated served0) 256)
(* (is-violated served1) 8)
(* (is-violated served2) 16)
(* (is-violated served3) 8)
(* (is-violated served4) 72)
(* (is-violated served5) 256)
(* (is-violated served6) 98)
)))
