(define (problem elevators-netbenefit-p8_4_1)
...
(:goal
(and
(preference served0 (passenger-at p0 n0)) 
(preference served1 (passenger-at p1 n7)) 
(preference served2 (passenger-at p2 n1)) 
(preference served3 (passenger-at p3 n5)) 
))

(:metric maximize (- 58 (+ (total-cost)
(* (is-violated served0) 2)
(* (is-violated served1) 2)
(* (is-violated served2) 50)
(* (is-violated served3) 4)
)))
