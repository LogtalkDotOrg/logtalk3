(define (problem elevators-netbenefit-p12_6_1)
...
(:goal
(and
(preference served0 (passenger-at p0 n11)) 
(preference served1 (passenger-at p1 n2)) 
(preference served2 (passenger-at p2 n1)) 
(preference served3 (passenger-at p3 n4)) 
(preference served4 (passenger-at p4 n6)) 
(preference served5 (passenger-at p5 n7)) 
))

(:metric maximize (- 222 (+ (total-cost)
(* (is-violated served0) 64)
(* (is-violated served1) 4)
(* (is-violated served2) 50)
(* (is-violated served3) 64)
(* (is-violated served4) 36)
(* (is-violated served5) 4)
)))
