(define (problem elevators-netbenefit-p12_4_2)
...
(:goal
(and
(preference served0 (passenger-at p0 n7)) 
(preference served1 (passenger-at p1 n10)) 
(preference served2 (passenger-at p2 n5)) 
(preference served3 (passenger-at p3 n4)) 
))

(:metric maximize (- 246 (+ (total-cost)
(* (is-violated served0) 100)
(* (is-violated served1) 64)
