(define (problem elevators-netbenefit-p12_5_3)
...
(:goal
(and
(preference served0 (passenger-at p0 n8)) 
(preference served1 (passenger-at p1 n6)) 
(preference served2 (passenger-at p2 n2)) 
(preference served3 (passenger-at p3 n4)) 
(preference served4 (passenger-at p4 n7)) 
))

(:metric maximize (- 138 (+ (total-cost)
(* (is-violated served0) 64)
(* (is-violated served1) 4)
(* (is-violated served2) 16)
(* (is-violated served3) 50)
