...
echo "* Ciao Prolog (1.19.0 or later):     ciaolgt     (experimental; first run may require sudo)"
...
echo "* LVM (1.0.0 or later):              lvmlgt      (experimental)"
echo "* Qu-Prolog (9.7 or later):          qplgt"
...
echo "* Trealla ProLog (1.2.122 or later): tplgt       (experimental)"
