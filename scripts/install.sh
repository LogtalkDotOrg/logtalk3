...
echo "* XSB (version 3.3 or later):              xsblgt     (first run may require sudo)"
echo "* XSB 64 bits (version 3.3 or later):      xsb64lgt   (first run may require sudo)"
echo "* XSB MT (version 3.3 or later):           xsbmtlgt   (first run may require sudo)"
echo "* XSB MT 64 bits (version 3.3 or later):   xsbmt64lgt (first run may require sudo)"
