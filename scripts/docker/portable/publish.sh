...
docker build --no-cache --build-arg LOGTALK_VERSION=${VERSION} --build-arg LOGTALK_TEXINFO_VERSION=${TEXINFO} -t logtalk/logtalk3-portable -t logtalk/logtalk3-portable:${TAG} .
