...
Name: "prolog\trealla"; Description: "Trealla Prolog integration (2.18.7 or later)"; Types: full prolog custom; Flags: disablenouninstallwarning
...
Source: "{#MyBaseDir}\scripts\embedding\arriba\*.ps1"; DestDir: "{win}"; Components: base; Flags: ignoreversion; Check: IsAdminInstallMode
