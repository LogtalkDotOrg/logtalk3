...
#define MyAppCopyright "Copyright © 1998-2022 Paulo Moura"
...
Name: "prolog\tau"; Description: "Tau Prolog integration (0.3.1 or later)"; Types: full prolog custom; Flags: disablenouninstallwarning
...
begin
  if IsWin64 then
    if RegQueryStringValue(HKLM64, 'Software\SICS\SICStus4.7_win32\', 'SP_PATH', SP_PATH) or
    ...
    if RegQueryStringValue(HKLM, 'Software\SICS\SICStus4.7_win32\', 'SP_PATH', SP_PATH) or
