...
Source: http://logtalk.org/files/lgt3000.tar.bz2
...
echo "* XSB (version 3.3 or later):              xsblgt"
echo "* XSB 64 bits (version 3.3 or later):      xsb64lgt"
echo "* XSB MT (version 3.3 or later):           xsbmtlgt"
echo "* XSB MT 64 bits (version 3.3 or later):   xsbmt64lgt"
...
echo "scripts, consult the \"/usr/local/share/logtalk/adapters/NOTES.txt\" file"
...
if [ -x /usr/bin/update-mime-database ]; then
	...
	cp /usr/local/share/lgt3000/scripts/freedesktop/logtalk.xml /usr/share/mime/packages/logtalk.xml
