%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%  Adapter file for Trealla Prolog 1.11.25 and later versions
...
:- set_prolog_flag(indexing_threshold, 400).
...
'$lgt_prolog_feature'(prolog_compatible_version, '@>='(v(1, 11, 25))).
