...
user:prolog_predicate_name(user:'$lgt_call_in_this_checked'(_, _), 'call/1') :- !.
...
user:prolog_predicate_name(user:'$lgt_threaded_cancel_tagged'(_, _), 'threaded_cancel/1') :- !.
...
user:prolog_predicate_name(user:'$lgt_threaded_engine_next'(_, _, _), 'threaded_engine_next/2') :- !.
user:prolog_predicate_name(user:'$lgt_threaded_engine_yield'(_, _), 'threaded_engine_yield/1') :- !.
