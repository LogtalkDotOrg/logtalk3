...
:- use_module(library(terms), [numbervars/3]).
...
'$lgt_prolog_feature'(prolog_version, v(0, 9, 0)).
...
:- use_module(library(iso_ext), [copy_term_nat/2]).
...
atomic_concat(Atomic1, Atomic2, Atom) :-
	...
	;	'$lgt_scryer_atomic_atom'(Atomic1, Atom1),
		'$lgt_scryer_atomic_atom'(Atomic2, Atom2),
		atom_concat(Atom1, Atom2, Atom)
	).

'$lgt_scryer_atomic_atom'(Atomic, Atom) :-
	(	atom(Atomic) ->
		Atom = Atomic
...
atomic_list_concat([Atomic| Atomics], Atom) :-
	...
	;	'$lgt_scryer_atomic_atom'(Atomic, Atom0),
		'$lgt_scryer_atomic_list_concat'(Atomics, Atom0, Atom)
	).
atomic_list_concat([], '').

'$lgt_scryer_atomic_list_concat'([Next| Atomics], Atom0, Atom) :-
	!,
	atomic_list_concat([Next| Atomics], Atom1),
	atom_concat(Atom0, Atom1, Atom).
'$lgt_scryer_atomic_list_concat'([], Atom, Atom).
...
atomic_list_concat([Atomic| Atomics], Separator, Atom) :-
	...
	;	'$lgt_scryer_atomic_atom'(Atomic, Atom0),
		'$lgt_scryer_atomic_atom'(Separator, SeparatorAtom),
		'$lgt_scryer_atomic_list_concat'(Atomics, Atom0, SeparatorAtom, Atom)
	).
atomic_list_concat([], _, '').

'$lgt_scryer_atomic_list_concat'([Next| Atomics], Atom0, SeparatorAtom, Atom) :-
	!,
	atomic_list_concat([Next| Atomics], SeparatorAtom, Atom2),
	atom_concat(SeparatorAtom, Atom2, Atom1),
	atom_concat(Atom0, Atom1, Atom).
'$lgt_scryer_atomic_list_concat'([], Atom, _, Atom).
