...
atomic_concat(Atomic1, Atomic2, Atom) :-
	...
	;	'$lgt_minerva_atomic_atom'(Atomic1, Atom1),
		'$lgt_minerva_atomic_atom'(Atomic2, Atom2),
...
atomic_list_concat([Atomic| Atomics], Atom) :-
	...
	;	'$lgt_minerva_atomic_atom'(Atomic, Atom0),
		'$lgt_minerva_atomic_list_concat'(Atomics, Atom0, Atom)
	).
atomic_list_concat([], '').

'$lgt_minerva_atomic_list_concat'([Next| Atomics], Atom0, Atom) :-
	!,
	atomic_list_concat([Next| Atomics], Atom1),
	atom_concat(Atom0, Atom1, Atom).
'$lgt_minerva_atomic_list_concat'([], Atom, Atom).
...
atomic_list_concat([Atomic| Atomics], Separator, Atom) :-
	...
	;	'$lgt_minerva_atomic_atom'(Atomic, Atom0),
		...
		'$lgt_minerva_atomic_list_concat'(Atomics, Atom0, SeparatorAtom, Atom)
	).
atomic_list_concat([], _, '').

'$lgt_minerva_atomic_list_concat'([Next| Atomics], Atom0, SeparatorAtom, Atom) :-
	!,
	atomic_list_concat([Next| Atomics], SeparatorAtom, Atom2),
	atom_concat(SeparatorAtom, Atom2, Atom1),
	atom_concat(Atom0, Atom1, Atom).
'$lgt_minerva_atomic_list_concat'([], Atom, _, Atom).
