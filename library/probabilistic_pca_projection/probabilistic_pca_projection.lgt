...
:- object(probabilistic_pca_projection,
	...
	:- info([
		...
		see_also is [kernel_pca_projection, pca_projection, truncated_svd_projection]
	]).
	...
	valid_probabilistic_pca_diagnostics(Components, Loadings, ExplainedVariances, Diagnostics) :-
		...
		memberchk(model(probabilistic_pca_projection), Diagnostics),
	...
	build_diagnostics(AttributeNames, SampleCount, Components, ExplainedVariances, NoiseVariance, Options, ExtractionDiagnostics, Diagnostics) :-
		...
		^^base_dimension_reducer_diagnostics(probabilistic_pca_projection, AttributeNames, Components, Options, [
