...
:- object(tests_performance,
	...
	:- info([
		...
		date is 2026-04-23,
		comment is 'Performance and reference-fit benchmarks for the "optics" library.'
	]).
	...
	reference_fit(Dataset, Options, ExpectedClusterCount, MaximumNoiseCount, MinimumCoreDistance, TrainTime, ClusterCount, NoiseCount, MinCoreDistance) :-
		benchmark(optics::learn(Dataset, _Clusterer, Options), TrainTime),
		optics::learn(Dataset, Clusterer, Options),
