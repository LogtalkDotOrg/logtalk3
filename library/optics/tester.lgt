...
:- initialization((
	...
	logtalk_load(optics, [debug(on), source_data(on)]),
	logtalk_load([
		clustering_protocols('test_datasets/all_noise'),
		clustering_protocols('test_datasets/bridge_noise'),
		clustering_protocols('test_datasets/duplicate_points'),
		clustering_protocols('test_datasets/two_blobs'),
		clustering_protocols('test_datasets/scaling_bands'),
		clustering_protocols('test_datasets/single_blob'),
