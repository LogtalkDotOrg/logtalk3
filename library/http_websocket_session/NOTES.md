...
includes higher-level callback loops and a registry-backed broadcast helper for
upgraded `http_socket` WebSocket connections.
...
and choose the libraries index and then the `http_websocket_session` library.
