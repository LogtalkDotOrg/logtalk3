...
:- initialization((
	...
	logtalk_load([
		...
		'test_datasets/two_item_measurements',
		'test_datasets/regular_measurements',
		'test_datasets/cyclic_measurements',
		'test_datasets/disconnected_measurements',
		...
		'test_datasets/malformed_measurement_self',
		'test_datasets/malformed_measurement_non_numeric',
		'test_datasets/malformed_measurement_non_positive_weight',
