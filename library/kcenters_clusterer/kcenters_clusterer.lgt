...
:- object(kcenters_clusterer,
	...
	:- info([
		...
		see_also is [clusterer_protocol, clustering_dataset_protocol, kmeans_clusterer, kmedoids_clusterer, kmedians_clusterer]
	]).
	...
	check_clusterer(Clusterer) :-
		(	clusterer_data(Clusterer, Encoders, Centers, Options, Diagnostics),
			...
			^^valid_clusterer_metadata(kcenters_clusterer, Options, Diagnostics),
			length(Centers, CenterCount),
