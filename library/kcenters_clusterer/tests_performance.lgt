...
:- object(tests_performance,
	...
	:- info([
		...
		date is 2026-04-24,
		comment is 'Performance and reference-fit benchmarks for the "kcenters_clusterer" library.'
	]).
	...
	reference_fit(Dataset, Options, MaximumCoveringRadius, MinimumCenterDistance, TrainTime, CoveringRadius, MinCenterDistance) :-
		benchmark(kcenters_clusterer::learn(Dataset, _Clusterer, Options), TrainTime),
		kcenters_clusterer::learn(Dataset, Clusterer, Options),
	...
	covering_radius([AttributeValues| Examples], Clusterer, CoveringRadius) :-
		...
		kcenters_clusterer::cluster(Clusterer, AttributeValues, Cluster),
