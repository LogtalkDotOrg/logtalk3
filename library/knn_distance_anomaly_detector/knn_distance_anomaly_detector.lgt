...
:- object(knn_distance_anomaly_detector,
	...
	:- info([
		...
		see_also is [anomaly_dataset_protocol, anomaly_detector_protocol, isolation_forest_anomaly_detector, lof_anomaly_detector]
	]).
	...
	check_anomaly_detector(Detector) :-
		...
		Diagnostics = [
			model(knn_distance_anomaly_detector),
	...
	valid_detector_diagnostics(Dataset, AttributeNames, FeatureTypes, Instances, ReferenceScores, Diagnostics) :-
		...
		memberchk(model(knn_distance_anomaly_detector), Diagnostics),
