...
:- object(tests,
	...
	test(naive_bayes_valid_classifier_1, deterministic(naive_bayes_classifier::valid_classifier(Classifier))) :-
		naive_bayes_classifier::learn(weather, Classifier).

	test(naive_bayes_invalid_classifier_1, fail) :-
		naive_bayes_classifier::valid_classifier(nb_classifier(
			[yes, no],
			[yes-0.6, no-0.6],
			[outlook],
			[categorical],
	...
	test(naive_bayes_predict_3_weather_01, true(Prediction == yes)) :-
		naive_bayes_classifier::learn(weather, Classifier),
		naive_bayes_classifier::predict(Classifier, [outlook-overcast, temperature-hot, humidity-normal, wind-weak], Prediction).

	test(naive_bayes_predict_3_weather_02, true(Prediction == no)) :-
		naive_bayes_classifier::learn(weather, Classifier),
		naive_bayes_classifier::predict(Classifier, [outlook-sunny, temperature-cool, humidity-high, wind-strong], Prediction).

	test(naive_bayes_predict_3_weather_03, true(Prediction == yes)) :-
		naive_bayes_classifier::learn(weather, Classifier),
		naive_bayes_classifier::predict(Classifier, [outlook-rainy, temperature-mild, humidity-high, wind-weak], Prediction).
	...
	test(naive_bayes_predict_probability_3_weather, true(ProbabilityNo =~= 0.015374453352769681)) :-
		naive_bayes_classifier::learn(weather, Classifier),
		naive_bayes_classifier::predict_probabilities(Classifier, [outlook-rainy, temperature-mild, humidity-high, wind-weak], Probabilities),
	...
	test(naive_bayes_learn_2_iris, true(ground(Classifier))) :-
		naive_bayes_classifier::learn(iris_small, Classifier).

	% Test predict/3 with iris dataset (continuous features)
	test(naive_bayes_predict_3_iris_setosa, true(Prediction == setosa)) :-
		naive_bayes_classifier::learn(iris_small, Classifier),
		naive_bayes_classifier::predict(Classifier, [sepal_length-5.0, sepal_width-3.3, petal_length-1.4, petal_width-0.2], Prediction).

	test(naive_bayes_predict_3_iris_versicolor, true(Prediction == versicolor)) :-
		naive_bayes_classifier::learn(iris_small, Classifier),
		naive_bayes_classifier::predict(Classifier, [sepal_length-6.5, sepal_width-3.0, petal_length-4.6, petal_width-1.4], Prediction).

	test(naive_bayes_predict_3_iris_virginica, true(Prediction == virginica)) :-
		naive_bayes_classifier::learn(iris_small, Classifier),
		naive_bayes_classifier::predict(Classifier, [sepal_length-6.7, sepal_width-3.1, petal_length-5.6, petal_width-2.4], Prediction).
	...
	test(naive_bayes_predict_probability_3_iris_virginica, true(ProbabilityVirginica =~= 0.3209286115664264)) :-
		naive_bayes_classifier::learn(iris_small, Classifier),
		naive_bayes_classifier::predict_probabilities(Classifier, [sepal_length-6.7, sepal_width-3.1, petal_length-5.6, petal_width-2.4], Probabilities),
	...
	test(naive_bayes_learn_2_mixed, true(ground(Classifier))) :-
		naive_bayes_classifier::learn(mixed, Classifier).

	% Test predict/3 with mixed dataset
	test(naive_bayes_predict_3_mixed_01, true(Prediction == no)) :-
		naive_bayes_classifier::learn(mixed, Classifier),
		naive_bayes_classifier::predict(Classifier, [age-26, income-36000, student-yes, credit_rating-fair], Prediction).

	test(naive_bayes_predict_3_mixed_02, true(Prediction == yes)) :-
		naive_bayes_classifier::learn(mixed, Classifier),
		naive_bayes_classifier::predict(Classifier, [age-48, income-80000, student-no, credit_rating-excellent], Prediction).
	...
	test(naive_bayes_predict_probability_3_mixed_no, true(ProbabilityNo =~= 6.856764584660943e-22)) :-
		naive_bayes_classifier::learn(mixed, Classifier),
		naive_bayes_classifier::predict_probabilities(Classifier, [age-48, income-80000, student-no, credit_rating-excellent], Probabilities),
		memberchk(no-ProbabilityNo, Probabilities).
	...
	test(naive_bayes_export_to_clauses_3, true(Prediction == yes)) :-
		naive_bayes_classifier::learn(weather, Classifier),
		naive_bayes_classifier::export_to_clauses(_Dataset, Classifier, classifier, [classifier(ExportedClassifier)]),
		naive_bayes_classifier::predict(ExportedClassifier, [outlook-overcast, temperature-hot, humidity-normal, wind-weak], Prediction).
	...
	test(naive_bayes_export_to_file_4_written, deterministic(os::file_exists(File))) :-
		...
		naive_bayes_classifier::learn(weather, Classifier),
		naive_bayes_classifier::export_to_file(weather, Classifier, classify, File).
	...
	test(naive_bayes_export_to_file_3_loaded, true(Prediction == yes)) :-
		^^file_path('test_output.pl', File),
		naive_bayes_classifier::learn(weather, Classifier),
		naive_bayes_classifier::export_to_file(weather, Classifier, classifier, File),
		logtalk_load(File),
	...
	test(naive_bayes_print_classifier_1, true) :-
		...
		naive_bayes_classifier::learn(mixed, Classifier),
		naive_bayes_classifier::print_classifier(Classifier).
