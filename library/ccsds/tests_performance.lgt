...
:- object(tests_performance,
	...
	% Performance test: parse 1 packet 1000000 times
	test(parse_1_packet_1000000_times, true, [note(seconds-Time)]) :-
		bytes_(Bytes),
		lgtunit::benchmark(ccsds::parse(Bytes, _), 1000000, Time).
