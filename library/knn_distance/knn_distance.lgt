...
:- object(knn_distance,
	...
	anomaly_detector_term_template(knn_distance_detector(_TrainingDataset, _AttributeNames, _FeatureTypes, _AttributeScales, _Instances, _ReferenceScores, _Diagnostics), knn_distance_detector('TrainingDataset', 'AttributeNames', 'FeatureTypes', 'AttributeScales', 'Instances', 'ReferenceScores', 'Diagnostics')).
	...
	valid_detector_diagnostics(Dataset, AttributeNames, FeatureTypes, Instances, ReferenceScores, Diagnostics) :-
		...
		memberchk(model(knn_distance), Diagnostics),
