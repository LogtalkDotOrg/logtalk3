...
:- object(open_id_der,
	...
	:- info(public_key_pem/2, [
		...
		argnames is ['Key', 'PEM'],
		exceptions is [
			'``Key`` is not a supported RSA or P-256 EC public JWK' - domain_error(open_id_jwk_public_key, 'Key'),
	...
	:- info(es256_signature_der/2, [
		comment is 'Converts a raw ES256 signature into DER-encoded ASN.1 form.',
