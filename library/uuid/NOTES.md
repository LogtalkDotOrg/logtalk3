...
applications due to improved entropy and sortability characteristics.

UUIDs can be generated as atoms, lists of characters, or lists of character
codes.

See also the `cuid2`, `ksuid`, `ids`, `nanoid`, and `ulid` libraries.
...
Version 7 UUIDs are time-ordered using the Unix Epoch timestamp in milliseconds
(as specified in RFC 9562). By default, version 7 UUIDs are generated as atoms.
For example:
