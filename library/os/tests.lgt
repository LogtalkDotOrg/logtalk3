...
:- object(tests,
	...
	test(os_wall_time_1_02, true) :-
		...
		0.5 =< Seconds1 - Seconds0,
		Seconds1 - Seconds0 =< 1.5.
	...
	cleanup :-
		...
		object_property(This, file(_,Directory)),
		os::path_concat(Directory, ensure_file1, EnsureFile1),
		(os::file_exists(EnsureFile1) -> os::delete_file(EnsureFile1); true),
		os::path_concat(Directory, '1/2/ensure_file2', OneTwoEnsureFile2),
		(os::file_exists(OneTwoEnsureFile2) -> os::delete_file(OneTwoEnsureFile2); true),
		os::path_concat(Directory, '1/2', TwoEnsureFile2),
		(os::file_exists(TwoEnsureFile2) -> os::delete_file(TwoEnsureFile2); true),
		os::path_concat(Directory, '1', OneEnsureFile2),
		(os::file_exists(OneEnsureFile2) -> os::delete_file(OneEnsureFile2); true),
		os::path_concat(Directory, test_file, TestFile),
		(os::file_exists(TestFile) -> os::delete_file(TestFile); true),
		os::path_concat(Directory, test_file_1, TestFile1),
		(os::file_exists(TestFile1) -> os::delete_file(TestFile1); true),
		os::path_concat(Directory, test_file_2, TestFile2),
		(os::file_exists(TestFile2) -> os::delete_file(TestFile2); true),
		os::path_concat(Directory, test_copy_file, TestCopyFile),
		(os::file_exists(TestCopyFile) -> os::delete_file(TestCopyFile); true),
		os::path_concat(Directory, test_sub_directory, SubDirectory),
		(os::directory_exists(SubDirectory) -> os::delete_directory(SubDirectory); true),
		os::path_concat(Directory, 'sub_directory1/sub_directory2/sub_directory3', SubDirectory3),
		(os::directory_exists(SubDirectory3) -> os::delete_directory(SubDirectory3); true),
		os::path_concat(Directory, 'sub_directory1/sub_directory2', SubDirectory2),
		(os::directory_exists(SubDirectory2) -> os::delete_directory(SubDirectory2); true),
		os::path_concat(Directory, 'sub_directory1', SubDirectory1),
		(os::directory_exists(SubDirectory1) -> os::delete_directory(SubDirectory1); true),
		os::path_concat(Directory, 'ensure_directory1', EnsureDirectory1),
		(os::directory_exists(EnsureDirectory1) -> os::delete_directory(EnsureDirectory1); true),
		os::path_concat(Directory, 'a/b/ensure_directory2', ABEnsureDirectory2),
		(os::directory_exists(ABEnsureDirectory2) -> os::delete_directory(ABEnsureDirectory2); true),
