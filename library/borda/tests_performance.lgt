...
:- object(tests_performance,
	...
	:- info([
		...
		date is 2026-04-25,
		comment is 'Performance benchmarks for the "borda" library.'
	]).
	...
	reference_timing(TrainTime, Count, TopScore, BottomScore) :-
		benchmark(borda::learn(large_ranked_ballots, _Ranker), TrainTime),
		borda::learn(large_ranked_ballots, Ranker),
