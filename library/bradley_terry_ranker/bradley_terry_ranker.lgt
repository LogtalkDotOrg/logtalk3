...
:- object(bradley_terry_ranker,
	...
	:- info([
		...
		see_also is [pairwise_ranking_dataset_protocol, ranking_dataset_protocol, ranker_protocol, regularized_bradley_terry_ranker]
	]).
	...
	valid_ranker_data(Items, Strengths, Diagnostics) :-
		...
		^^valid_ranker_metadata(bradley_terry_ranker, Diagnostics),
