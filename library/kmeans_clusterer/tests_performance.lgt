...
:- object(tests_performance,
	...
	:- info([
		...
		date is 2026-05-06,
		comment is 'Performance and reference-fit benchmarks for the "kmeans_clusterer" library.'
	]).
	...
	reference_fit(Dataset, Options, MaximumInertia, MinimumCentroidDistance, TrainTime, Inertia, MinCentroidDistance) :-
		benchmark(kmeans_clusterer::learn(Dataset, _Clusterer, Options), TrainTime),
		kmeans_clusterer::learn(Dataset, Clusterer, Options),
	...
	training_inertia([AttributeValues| Examples], Clusterer, Inertia) :-
		...
		kmeans_clusterer::cluster(Clusterer, AttributeValues, Cluster),
