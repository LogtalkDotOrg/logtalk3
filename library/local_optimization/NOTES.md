...
- `gradient(+Point, -Gradient)` - **required** by gradient descent and
  conjugate gradient. When missing those solvers raise an existence error.
...
- Projected steps after a BFGS or L-BFGS update can similarly weaken
  the quasi-Newton model; a pure bound-constrained formulation
