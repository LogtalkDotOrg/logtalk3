...
:- object(tests,
	...
	test(call_with_timeout_2_01, ball(timeout((repeat,fail))), [condition((current_logtalk_flag(prolog_dialect, Dialect), Dialect \== swi, Dialect \== trealla))]) :-
	...
	test(call_with_timeout_3_01, true(Result == timeout), [condition((current_logtalk_flag(prolog_dialect, Dialect), Dialect \== swi, Dialect \== trealla))]) :-
