...
:- object(spade_pattern_miner,
	...
	:- info([
		...
		see_also is [pattern_miner_protocol, sequence_dataset_protocol, prefix_span_pattern_miner, gsp_pattern_miner, clo_span_pattern_miner]
	]).
	...
	pattern_miner_diagnostics_data(spade_pattern_miner(ItemDomain, Patterns, Options), Diagnostics) :-
		^^pattern_miner_diagnostics(spade_pattern_miner, ItemDomain, Patterns, Options, [
