...
:- object(tests,
	...
	test(ccsds_secondary_header_time_02, true(Descriptor-Time == cuc_descriptor(4, 2, ccsds_epoch)-cuc_time(256, 128))) :-
	...
	test(ccsds_secondary_header_time_03, true(Time == cuc_time(256, 128))) :-
	...
	test(ccsds_secondary_header_time_04, true(Time == cds_time(1, 2000, 500000000))) :-
