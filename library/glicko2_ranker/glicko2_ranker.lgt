...
:- object(glicko2_ranker,
	...
	:- info([
		...
		see_also is [pairwise_ranking_dataset_protocol, ranker_protocol, elo_ranker, rank_centrality]
	]).
	...
	valid_score_ranker_diagnostics(Items, _Ratings, Diagnostics) :-
		^^valid_ranker_metadata(glicko2_ranker, Diagnostics),
	...
	score_ranker_model(glicko2_ranker).
