...
:- protocol(json_protocol).
	...
	:- info(generate/2, [
		...
		exceptions is [
			...
			'``Sink`` is neither a variable nor a valid JSON sink term' - domain_error(json_sink, 'Sink'),
			'A JSON version of ``Term`` cannot be generated by the implementation' - domain_error(json_term, 'Term')
		]
	]).
