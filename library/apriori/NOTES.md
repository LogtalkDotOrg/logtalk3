...
Open the [../../apis/library_index.html#apriori](../../apis/library_index.html#apriori)
...
To test this library predicates, load the `tester.lgt` file:
	...
	| ?- logtalk_load(apriori(tester)).


Features
--------

- **Deterministic Level-Wise Mining**: Builds frequent itemsets by deterministic candidate generation and support rescans.
- **Apriori Pruning**: Rejects candidate itemsets whose immediate subsets are not all frequent.
