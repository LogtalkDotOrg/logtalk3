...
:- object(tests,
	...
	test(prefix_span_diagnostics_2, deterministic((memberchk(model(prefix_span_pattern_miner), Diagnostics), memberchk(extension_modes([itemset, sequence]), Diagnostics), memberchk(support_layout(projected_database), Diagnostics)))) :-
