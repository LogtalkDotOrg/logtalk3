...
:- object(tests,
	...
	test(apriori_diagnostics_2, deterministic((memberchk(model(apriori_pattern_miner), Diagnostics), memberchk(candidate_generation(join_prune), Diagnostics), memberchk(candidate_counting(hash_tree), Diagnostics), memberchk(pattern_length_histogram([1-3, 2-1]), Diagnostics)))) :-
