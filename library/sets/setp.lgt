...
:- protocol(setp).
	...
	:- info(delete/3, [
		comment is 'Deletes an element from a set returning the set of the remaining elements.',
	...
	:- info(disjoint/2, [
		comment is 'True when the two sets have no element in common.',
	...
	:- info(equal/2, [
		comment is 'True when the two sets are equal.',
		argnames is ['Set1', 'Set2']
	]).
	...
	:- info(empty/1, [
		comment is 'True when the set is empty.',
		argnames is ['Set']
	]).
	...
	:- info(insert_all/3, [
		comment is 'Inserts all the elements of the list into a set, returning the resulting set.',
	...
	:- mode(intersection(@set, @set, -set), one).
	:- info(intersection/3, [
		comment is 'Computes the intersection of ``Set1`` and ``Set2``.',
		argnames is ['Set1', 'Set2', 'Intersection']
	]).

	:- public(intersection/4).
	:- mode(intersection(@set, @set, -set, -set), one).
	:- info(intersection/4, [
		comment is 'Computes the intersection and the difference between ``Set2`` and ``Set1``.',
	...
	:- info(memberchk/2, [
		comment is 'True when a term is a member of a set.',
		argnames is ['Element', 'Set']
	]).

	:- public(powerset/2).
	:- mode(powerset(@set, -list(set)), one).
	:- info(powerset/2, [
	...
	:- info(selectchk/3, [
		comment is 'True if an element can be selected from a set, returning the set of remaining elements.',
		argnames is ['Element', 'Set', 'Remaining']
	]).
	...
	:- public(subtract/3).
	:- mode(subtract(@set, @set, -set), one).
	:- info(subtract/3, [
		comment is 'Computes the set of all the elements of ``Set1`` which are not also in ``Set2``.',
		argnames is ['Set1', 'Set2', 'Difference']
	]).

	:- public(symdiff/3).
	:- mode(symdiff(@set, @set, -set), one).
	:- info(symdiff/3, [
		comment is 'Computes the symmetric difference of ``Set1`` and ``Set2``, containing all elements that are not in the sets intersection.',
		argnames is ['Set1', 'Set2', 'Difference']
	]).

	:- public(union/3).
	:- mode(union(@set, @set, -set), one).
	:- info(union/3, [
		comment is 'Computes the union of ``Set1`` and ``Set2``.',
		argnames is ['Set1', 'Set2', 'Union']
	]).

	:- public(union/4).
	:- mode(union(@set, @set, -set, -set), one).
	:- info(union/4, [
		comment is 'Computes the union of ``Set1`` and ``Set2`` and the difference between ``Set2`` and ``Set1``.',
