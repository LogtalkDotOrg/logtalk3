...
Learned regressors expose diagnostics using the shared `diagnostics/2`,
`diagnostic/2`, and `regressor_options/2` predicates. Concrete
regressor implementations store effective training options in the
