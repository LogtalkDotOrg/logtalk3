...
:- object(tests,
	...
	test(z_score_diagnostics_2, deterministic((memberchk(model(z_score_anomaly_detector), Diagnostics), memberchk(training_dataset(gaussian_anomalies), Diagnostics), memberchk(feature_count(2), Diagnostics), memberchk(example_count(40), Diagnostics)))) :-
		learn_filtered_gaussian_anomalies(Detector),
