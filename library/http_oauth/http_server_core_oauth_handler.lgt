...
:- object(http_server_core_oauth_handler(_Verifier_, _Handler_, _ProtectOptions_),
	...
	:- info([
		...
		date is 2026-09-01,
		comment is 'Wrapper HTTP handler object that applies OAuth Bearer protection around another portable HTTP handler.',
		parameters is [
	...
	handle(Request0, Response) :-
		http_oauth::protect_request(Request0, _Verifier_, Action, _ProtectOptions_),
