...
:- object(dbscan_clusterer,
	...
	:- info([
		...
		see_also is [clusterer_protocol, clustering_dataset_protocol, kcenters_clusterer, kmeans_clusterer, kmedoids_clusterer, kmedians_clusterer]
	]).
