...
Open the [../../apis/library_index.html#elo](../../apis/library_index.html#elo)
...
- **Deterministic Batch Elo Semantics**: Replays the dataset preference stream
  in enumeration order using the standard Elo expected-score formula.
...
- **Integer Weight Fidelity**: Preference weights must be positive integers
  and are interpreted as repeated unit outcomes.
