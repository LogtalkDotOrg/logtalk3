...
:- object(websocket_http_server_core_handler,
	...
	:- info([
		...
		date is 2026-07-08,
		comment is 'WebSocket handshake handler used by the http_server_core tests.'
	]).
...
:- object(websocket_no_protocol_http_server_core_handler,
	implements(http_handler_protocol)).
	...
	:- info([
		...
		author is 'Paulo Moura',
		date is 2026-07-08,
		comment is 'WebSocket handshake handler used by the http_server_core tests to exercise declining all offered subprotocols.'
	]).

	handle(Request, Response) :-
		http_server_core::accept_websocket(Request, Response, []).

:- end_object.


:- object(websocket_extensions_http_server_core_handler,
	implements(http_handler_protocol)).
	...
	:- info([
		...
		author is 'Paulo Moura',
		date is 2026-07-08,
		comment is 'WebSocket handshake handler used by the http_server_core tests to exercise unsupported extension negotiation.'
	]).
...
:- object(echo_http_handler,
	...
	:- info([
		...
		author is 'Paulo Moura',
		date is 2026-07-08,
		comment is 'Echo handler used by the http_server_core tests.'
	]).
...
:- object(fixed_body_http_handler,
	...
	:- info([
		...
		author is 'Paulo Moura',
		date is 2026-07-08,
		comment is 'Handler used by the http_server_core tests to return a fixed non-empty response body.'
	]).
...
:- object(closing_http_handler,
	...
	:- info([
		...
		author is 'Paulo Moura',
		date is 2026-07-08,
		comment is 'Handler used by the http_server_core tests to force connection closure.'
	]).
...
:- object(multipart_http_handler,
	...
	:- info([
		...
		author is 'Paulo Moura',
		date is 2026-07-08,
		comment is 'Multipart summary handler used by the http_server_core tests.'
	]).
