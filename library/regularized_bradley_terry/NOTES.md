...
Open the [../../apis/library_index.html#regularized_bradley_terry](../../apis/library_index.html#regularized_bradley_terry)
...
graph to be strongly connected, see the `bradley_terry` library.
...
- `model(regularized_bradley_terry)` identifies the learning algorithm that
  produced the ranker.
