...
:- initialization((
	...
	logtalk_load([
		clustering_protocols('test_datasets/dead_component_blobs'),
		clustering_protocols('test_datasets/duplicate_points'),
		clustering_protocols('test_datasets/imbalanced_three_modes'),
	...
	logtalk_load(gaussian_mixture_clusterer, [source_data(on), debug(on)]),
