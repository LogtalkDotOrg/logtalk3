...
:- object(tests_performance,
	...
	:- info([
		...
		date is 2026-05-06,
		comment is 'Performance and reference-fit benchmarks for the "gaussian_mixture_clusterer" library.'
	]).
	...
	reference_fit(Dataset, Options, MinimumWeight, MinimumMeanDistance, TrainTime, MinWeight, MinMeanDistance) :-
		benchmark(gaussian_mixture_clusterer::learn(Dataset, _Clusterer, Options), TrainTime),
		gaussian_mixture_clusterer::learn(Dataset, Clusterer, Options),
