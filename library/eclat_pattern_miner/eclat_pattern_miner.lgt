...
:- object(eclat_pattern_miner,
	...
	:- info([
		...
		see_also is [pattern_miner_protocol, transaction_dataset_protocol, apriori_pattern_miner, fp_growth_pattern_miner]
	]).
	...
	pattern_miner_diagnostics_data(eclat_pattern_miner(ItemDomain, Patterns, Options), Diagnostics) :-
		^^pattern_miner_diagnostics(eclat_pattern_miner, ItemDomain, Patterns, Options, [
