...
:- object(kemeny_young_ranker,
	...
	:- info([
		...
		see_also is [pairwise_ranking_dataset_protocol, ranker_protocol, ranked_pairs, schulze_ranker]
	]).
	...
	valid_score_ranker_diagnostics(Items, _Scores, Diagnostics) :-
		^^valid_ranker_metadata(kemeny_young_ranker, Diagnostics),
		memberchk(consensus_ranking(ConsensusRanking), Diagnostics),
	...
	score_ranker_model(kemeny_young_ranker).
