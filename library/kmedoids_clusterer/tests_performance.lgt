...
:- object(tests_performance,
	...
	:- info([
		...
		date is 2026-05-06,
		comment is 'Performance and reference-fit benchmarks for the "kmedoids_clusterer" library.'
	]).
	...
	reference_fit(Dataset, Options, MaximumInertia, MinimumMedoidDistance, TrainTime, Inertia, MinMedoidDistance) :-
		benchmark(kmedoids_clusterer::learn(Dataset, _Clusterer, Options), TrainTime),
		kmedoids_clusterer::learn(Dataset, Clusterer, Options),
	...
	training_inertia([AttributeValues| Examples], Clusterer, Inertia) :-
		...
		kmedoids_clusterer::cluster(Clusterer, AttributeValues, Cluster),
