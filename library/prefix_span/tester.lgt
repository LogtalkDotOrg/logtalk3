...
:- initialization((
	...
	logtalk_load([
		sequential_pattern_mining_protocols('test_datasets/border_threshold_sequences'),
		sequential_pattern_mining_protocols('test_datasets/branching_sequences'),
	...
	logtalk_load(prefix_span, [source_data(on), debug(on)]),
