...
:- object(tests_performance,
	...
	:- info([
		...
		date is 2026-04-23,
		comment is 'Performance and reference-fit benchmarks for the "dbscan" library.'
	]).
	...
	reference_fit(Dataset, Options, ExpectedClusterCount, MaximumNoiseCount, MinimumCoreDistance, TrainTime, ClusterCount, NoiseCount, MinCoreDistance) :-
		benchmark(dbscan::learn(Dataset, _Clusterer, Options), TrainTime),
		dbscan::learn(Dataset, Clusterer, Options),
