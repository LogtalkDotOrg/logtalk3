...
:- object(websocket_http_socket_transport_handler,
	...
	:- info([
		...
		date is 2026-07-08,
		comment is 'WebSocket handshake handler used by the http_socket_transport tests.'
	]).
...
:- object(echo_http_socket_transport_handler,
	...
	:- info([
		...
		author is 'Paulo Moura',
		date is 2026-07-08,
		comment is 'Echo handler used by the http_socket_transport tests.'
	]).
...
:- object(closing_http_socket_transport_handler,
	implements(http_handler_protocol)).
	...
	:- info([
		...
		author is 'Paulo Moura',
		date is 2026-07-08,
		comment is 'Handler used by the http_socket_transport tests to force connection-close responses.'
	]).
...
:- object(keep_alive_close_http_socket_transport_handler,
	implements(http_handler_protocol)).
	...
	:- info([
		...
		author is 'Paulo Moura',
		date is 2026-07-08,
		comment is 'Handler used by the http_socket_transport tests to keep the first HTTP/1.0 response persistent and require an explicit close on the second request.'
	]).
