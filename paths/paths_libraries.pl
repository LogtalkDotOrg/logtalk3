...
logtalk_library_path(byte_order, library('byte_order/')).
...
logtalk_library_path(http_websocket_service, library('http_websocket_service/')).
...
logtalk_library_path(svr_regression, library('svr_regression/')).
