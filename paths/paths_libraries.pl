...
logtalk_library_path(atms, library('atms/')).
...
logtalk_library_path(http_oauth, library('http_oauth/')).
...
logtalk_library_path(numerical_analysis, library('numerical_analysis/')).
...
logtalk_library_path(stop_words, library('stop_words/')).
