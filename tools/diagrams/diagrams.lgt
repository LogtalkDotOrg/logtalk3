...
:- object(diagrams(_Format)).
	...
	:- info([
		...
		date is 2014/06/18,
		comment is 'Predicates for generating all supported diagrams for libraries and files in one step using the specified format. Only common options should be specified.',
		parnames is ['Format'],
		remarks is [
