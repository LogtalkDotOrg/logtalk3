...
query resolved pack metadata and determine which installed packs contributed
code to the current session without reconstructing that information manually.
