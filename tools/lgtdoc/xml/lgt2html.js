...
var html_entity_xslt = logtalk_user + "\\tools\\lgtdoc\\xml\\logtalk_entity_to_html.xsl";
var xhtml_entity_xslt = logtalk_user + "\\tools\\lgtdoc\\xml\\logtalk_entity_to_xhtml.xsl";

var html_index_xslt = logtalk_user + "\\tools\\lgtdoc\\xml\\logtalk_index_to_html.xsl"
var xhtml_index_xslt = logtalk_user + "\\tools\\lgtdoc\\xml\\logtalk_index_to_xhtml.xsl"
...
if (p_arg != "" && p_arg != "msxsl" && p_arg != "xsltproc" && p_arg != "xalan" && p_arg != "saxon") {
...
WScript.Echo("");
WScript.Echo("Converting XML files to (X)HTML files...");
...
function usage_help() {
	...
	WScript.Echo("  p - XSLT processor (msxsl, xsltproc, xalan, or saxon; default is " + processor + ")");
	WScript.Echo("");
	WScript.Quit(1);
}
...
function create_index_file() {
	...
	if (FSObject.FileExists(WshShell.CurrentDirectory + "\\directory_index.xml")) {
		f.WriteLine("    <li><a href=\"library_index.html\">Library index</a></li>");
