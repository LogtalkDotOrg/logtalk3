...
:- object(coupling,
    ...
    :- info([
        ...
        remarks is [
            'Coupling'-'Any calls or dynamic updates to predicates in external objects \c
            or categories increments the coupling score. Any direct inheritance relations to the \c
            entity in question will also increment the score. Duplicate entity couplings will not \c
            be scored multiple times. Lower scores are generally better.'
        ]
    ]).
