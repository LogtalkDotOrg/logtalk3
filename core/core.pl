...
'$lgt_default_print_message'(information(_), _, _, _) :-
	'$lgt_compiler_flag'(report, warnings),
	!.

'$lgt_default_print_message'(warning(portability), _, _, _) :-
	'$lgt_compiler_flag'(portability, silent),
	!.

'$lgt_default_print_message'(warning(unknown_entities), _, _, _) :-
	'$lgt_compiler_flag'(unknown_entities, silent),
	!.

'$lgt_default_print_message'(warning(misspelt_calls), _, _, _) :-
	'$lgt_compiler_flag'(misspelt_calls, silent),
	!.

'$lgt_default_print_message'(warning(singleton_variables), _, _, _) :-
	'$lgt_compiler_flag'(singleton_variables, silent),
	!.
