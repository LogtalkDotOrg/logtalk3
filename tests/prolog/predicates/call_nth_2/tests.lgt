...
:- object(tests,
	...
	test(lgt_call_nth_2_04, error(domain_error(not_less_than_one, 0))) :-
		{call_nth(a, 0)}.

	test(lgt_call_nth_2_05, error(existence_error(procedure, Foo))) :-
		foo(Foo),
		{call_nth(Foo, _)}.

	test(lgt_call_nth_2_06, true(X == 1)) :-
		{call_nth(a(X), _)}.

	test(lgt_call_nth_2_07, deterministic(X == 2)) :-
		{call_nth(a(X), 2)}.

	test(lgt_call_nth_2_08, false) :-
		{call_nth(a(_), 7)}.

	test(lgt_call_nth_2_09, true(L == [1-1,2-2,3-3])) :-
